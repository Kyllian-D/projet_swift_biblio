...
Je ne suis pas encore satisfait du système de recherche des endoscopes, inspiré de mon application Android du semestre dernier, j'aimerais le rendre plus précis mais en même temps plus laxiste. Contradictoire mais je trouve que j'avais plutôt bien réussi cela pour l'application mobile.

L'aspect graphique est correcte, mais avec plus de temps j'aimerais le rendre plus jolie et la faire correspondre à la charte graphique de mon entreprise.
